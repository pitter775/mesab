...
<script>
    ...
    function ed_atualizatarifa(){
        $('#ed_tarifa').val(''); 
        console.log($('#ed_funcaos_id').val());
        if( $('#ed_funcaos_id').val() !== null){
            if($('#ed_funcaos_id').val() !== ''){
                var dados = {'funcao':$('#ed_funcaos_id').val() }
                console.log(dados);
                $.get(appUrl+'/tarifas/get', dados, function(retorno){               
                    $('#ed_tarifa').val(retorno);
                    $('#ed_tarifa').trigger("change"); 
                }); 
                $('#ed_tarifa').trigger("change"); 
            }
        }
